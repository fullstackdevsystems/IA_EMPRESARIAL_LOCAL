...
if len(sys.argv) < 2:
    raise SystemExit(
        "Uso: python test_r10_13d12_e2e_contextual_drill_through.py <dashboard.html>"
    )
...
print()
print("=== R10.13D.12 E2E CONTEXTUAL DRILL-THROUGH ===")
print(f"Archivo: {p}")
...
check("d12_modal_host", "r13bDrillThroughModal" in t)
check("d12_open_function", "function openDrillThrough(" in t)
check("d12_context_uses_rows", "rows().filter(" in t)
check("d12_dimension_button", "data-r13b-drill-through-column" in t)
check("d12_button_binding", "r13bDrillThroughColumn" in t)
check("d12_close", "data-r13b-drill-through-close" in t)
...
print()
print("PASS R10.13D.12 E2E CONTEXTUAL DRILL-THROUGH")
