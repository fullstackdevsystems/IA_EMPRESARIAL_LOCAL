...
ck('replaces_managed_runtime',"$stagedScripts = Join-Path $backupRoot 'new_scripts'" in ps and 'Move-Item $stagedScripts (Join-Path $RuntimeRoot \'scripts\')' in ps and scripts)
