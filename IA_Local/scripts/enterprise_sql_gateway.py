...
class EnterpriseSqlConnectionStore:
    ...
    def _read(self, path: Path) -> Dict[str, Any]:
        ...
        return record
    def register(self, *, scope: Dict[str, Any], connection_id: str, server: str, database: str, auth_mode: str, credential_ref: str, allowed_schemas: List[str], allowed_tables: List[str], enabled: bool = True) -> Dict[str, Any]:
        ...
        if not str(server).strip() or not str(database).strip() or not str(credential_ref).startswith("env:"):
