...
document.getElementById('send').onclick=send;document.getElementById('stop').onclick=stopGeneration;document.getElementById('uploadSource').onclick=uploadSource;document.getElementById('q').addEventListener('keydown',e=>{if(e.ctrlKey&&e.key==='Enter')send()});if(token){establishSession()}else{showLogin()}
</script></body></html>
"""
