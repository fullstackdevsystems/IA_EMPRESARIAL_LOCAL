...
def compile_enterprise_prompt(
    ...
    out["warnings"] = warnings + [
        "R9.8 compiló un plan de ejecución auditable, métricas, filtros, componentes dinámicos y exportación XLSX real desde el prompt.",
    ...
    out["planner"] = str(out.get("planner") or "validated") + "|enterprise-prompt-compiler-r9.8"
    return out
