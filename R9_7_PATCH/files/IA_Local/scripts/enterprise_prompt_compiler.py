...
def compile_enterprise_prompt(
    ...
    out["warnings"] = warnings + [
        "R9.7 compiló un plan de ejecución auditable, métricas, filtros y componentes dinámicos desde el prompt.",
    ...
    out["planner"] = str(out.get("planner") or "validated") + "|enterprise-prompt-compiler-r9.7"
    return out
