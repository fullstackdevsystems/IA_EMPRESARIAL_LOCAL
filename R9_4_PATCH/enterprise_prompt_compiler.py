...
def compile_enterprise_prompt(
    ...
    out["warnings"] = warnings + [
        "R9.4 compiló métricas, filtros y visualizaciones explícitas desde el prompt.",
    ...
    out["planner"] = str(out.get("planner") or "validated") + "|enterprise-prompt-compiler-r9.4"
    return out
