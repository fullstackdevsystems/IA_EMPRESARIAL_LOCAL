...
"installed_version":(
    (root/"VERSION.txt").read_text(encoding="utf-8").strip() in {
        "8.5.5-r10.11.1-data-contract-hotfix",
        "8.5.5-r10.12-controlled-finetune-dataset+hotfix-r10.11.1-data-contract",
    }
),
}
