...
def compile_enterprise_prompt(
    ...
    out["warnings"] = warnings + [
        "R10.1 compiló un plan de ejecución auditable, métricas, filtros, componentes dinámicos, XLSX real y consulta natural determinística desde el prompt.",
    ...
    out["planner"] = str(out.get("planner") or "validated") + "|enterprise-prompt-compiler-r10.1"
    return out
