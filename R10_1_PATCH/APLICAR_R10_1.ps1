...
if ($LASTEXITCODE -eq 0 -and $branch -eq 'main') {
    throw "R10.1 no debe aplicarse directamente sobre main. Cree/cambie primero a feature/r10-dashboard-intelligence."
}

$stamp = Get-Date -Format 'yyyyMMdd_HHmmss'
$Backup = Join-Path $Root "_backup_r10_1\$stamp"
...
Write-Host ''
Write-Host 'R10.1 aplicado correctamente.' -ForegroundColor Green
Write-Host 'Nuevo: dashboard ejecutivo menos cargado, gráficas autoexplicativas, valores visibles, referencias de cálculo, cobertura visual y vistas secundarias bajo demanda.'
Write-Host 'También incluye selector Top 10 por defecto, tabla 10/20/50/Todos y corrección robusta del filtro Todos.'
Write-Host "Backup: $Backup"
Write-Host 'Versión objetivo: 8.5.5-r10.1'
